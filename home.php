...
<nav class="navbar navbar-expand-lg navbar-light bg-primary">
  ...
  <a class="navbar-brand text-white fw-bold" href="#">Perpustakaan</a>
...
<div class="box-pendidikan">
  ...
  <div class="box-kiri">
    <img src="img/pinjam.jpg" alt="" class="img-fluid">
    <p><h2 class="text-primary">Peminjaman Buku</h2></p>
  </div>

  <div class="box-tengah">
    <img src="img/buku.jpg" alt="" class="img-fluid">
    <p><h2 class="text-primary">Jenis Buku</h2></p>
    <p class="text-primary">pemrograman, akutansi, sejarah, ekonomi, bisnis, dll.</p>
  </div>

  <div class="box-kanan">
    <img src="img/kembali.jpg" alt="" class="img-fluid">
    <p><h2 class="text-primary">Pengembalian Buku</h2></p>
  </div>
</div>
